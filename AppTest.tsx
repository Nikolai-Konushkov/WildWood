...
import {BackHandler, Button, StatusBar, View, Alert} from 'react-native';
...
const App = () => {
  ...
  let shareContent = params => {
    // Здесь будет вызываться шаринг в другие приложения
    // Share.share({
    //   title: 'lala',
    //   message:
    ...
    share({
      ...
      message: ' ' + params.link + ' ' + params.description,
